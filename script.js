...
theme?.addEventListener("click", () => {
  if (currMode === "light") {
    ...
    // Check if togBtn exists
    if (togBtn) {
      togBtn.style.display = "block";
    }
  } else {
    currMode = "light";
    ...
    // Check if document.body exists
    if (document.body) {
      document.body.style.backgroundImage = "url('https://www.hitaambrish.com/stat/img/home/quotes-bg.jpg')";
    }

    // Check if mainHeading exists
    if (mainHeading) {
      mainHeading.style.background = "linear-gradient(to right, #30cfd0 20%, #330867 100%)";
      mainHeading.style.webkitBackgroundClip = "text";
      mainHeading.style.webkitTextFillColor = "transparent";
    }
